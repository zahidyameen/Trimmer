package com.zsoft.trimmer.library.ui.seekbar.widgets;
...
import com.zsoft.trimmer.library.ui.seekbar.interfaces.OnRangeSeekbarChangeListener;
import com.zsoft.trimmer.library.ui.seekbar.interfaces.OnRangeSeekbarFinalValueListener;
    ...
    public synchronized boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Log.e("ddkkdkdkdkdkdkdkk", "MotionEvent.ACTION_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                Log.e("ddkkdkdkdkdkdkdkk", "MotionEvent.ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP:
                Log.e("ddkkdkdkdkdkdkdkk", "MotionEvent.ACTION_UP");
                if (mIsDragging) {
                    trackTouchEvent(event);
                    onStopTrackingTouch();
                    setPressed(false);
            ...
            case MotionEvent.ACTION_POINTER_UP:
                Log.e("ddkkdkdkdkdkdkdkk", "MotionEvent.ACTION_POINTER_UP");
                /*onSecondaryPointerUp(event);*/
                invalidate();
                break;
            case MotionEvent.ACTION_CANCEL:
                Log.e("ddkkdkdkdkdkdkdkk", "MotionEvent.ACTION_CANCEL");
                if (mIsDragging) {
                    onStopTrackingTouch();
                    setPressed(false);
                    touchUp(event.getX(pointerIndex), event.getY(pointerIndex));
...
//        float sec = (maxValue / 1000);
//        float pointPerSec = 100 / sec;
//        float gap = pointPerSec * 10;
//        if (absoluteMaxValue - absoluteMinValue < gap) {
//            Log.e("dkdkdkdkdkdk=>", "canMove");
//
//            return true;
//        } else {
//            Log.e("dkdkdkdkdkdk=>", "can not Move");
//            return false;
//        }
//    }
}
